...
class AdminSiteTests(TestCase):
    ...
    def setUp(self):
        ...
        self.client = (
            Client()
        )  # Django test class that allows user to make HTTP Requests
    ...
    def test_users_list(self):
        ...
        )  # get the URL for the list of users in the admin section
        res = self.client.get(
            url
        )  # make the HTTP GET Request for the URL (using the setUp Client instance)
