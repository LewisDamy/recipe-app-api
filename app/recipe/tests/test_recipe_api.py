...
def image_upload_url(recipe_id):
    """Create and return an imaged upload URL"""
...
class PrivateRecipeAPITests(TestCase):
    ...
    def setUp(self):
        self.client = APIClient()
        self.user = create_user(email='user@exampe.com', password='test123')
    ...
    def test_retrieve_recipes(self):
        ...
        recipes = Recipe.objects.all().order_by('-id')  # returning in reverse order
    ...
    def test_full_update(self):
        ...
        recipe = create_recipe(
            user=self.user,
            title='Sample recipe title',
            link='httpsH//example.com/recipe.pdf',
